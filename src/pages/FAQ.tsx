                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                            Everything you need to know about CS Connect
                            Pakistan
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="inline-block bg-white text-black px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-200 cursor-pointer"
                        >
                            Contact Us
                        </motion.div>
                    </motion.div>
