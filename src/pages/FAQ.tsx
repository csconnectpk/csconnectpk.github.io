        ...
        <div className="min-h-screen">
            ...
            <section className="relative bg-white overflow-hidden">
                ...
                <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-28 lg:pt-32 pb-12 sm:pb-16 lg:pb-20 text-center">
                    <div>
                        <div className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-200/60 mb-4 sm:mb-6 shadow-sm">
                            <HelpCircle className="w-3 h-3 sm:w-4 sm:h-4 text-purple-600 mr-2" />
                            <span className="text-xs sm:text-sm font-semibold text-purple-700 tracking-wide">Frequently Asked Questions</span>
                        </div>
                        ...
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-gray-900 mb-4 sm:mb-6 leading-tight tracking-tight">
                            <span className="block mb-1 sm:mb-2">Everything You Need</span>
