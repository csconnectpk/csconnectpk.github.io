        ...
        <div className="min-h-screen">
            ...
            <section className="relative bg-white overflow-hidden">
                ...
                <div className="relative max-w-6xl mx-auto px-6 sm:px-8 lg:px-8 pt-24 sm:pt-32 lg:pt-40 pb-16 sm:pb-20 lg:pb-24 text-center">
                    <div className="inline-flex items-center px-5 py-3 sm:px-6 sm:py-3 rounded-full bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200/60 mb-8 sm:mb-10 shadow-sm">
                        <Users className="w-5 h-5 sm:w-5 sm:h-5 text-green-600 mr-3" />
                        <span className="text-lg sm:text-base font-semibold text-green-700 tracking-wide">Join Our Community</span>
                    </div>
                    ...
                    <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-gray-900 mb-6 sm:mb-8 leading-[1.1] sm:leading-[1.05] tracking-tight">
                        <span className="block mb-2 sm:mb-1">Connect with CS Students</span>
