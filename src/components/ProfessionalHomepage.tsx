...
import { FaGithub, FaLinkedin, FaDiscord, FaWhatsapp, FaInstagram, FaYoutube } from 'react-icons/fa';
...
const platformStats = [
  { platform: 'WhatsApp', members: '2,000+', icon: FaWhatsapp, color: 'text-green-600' },
  { platform: 'Discord', members: '400+', icon: FaDiscord, color: 'text-indigo-600' },
  { platform: 'Instagram', members: '150+', icon: FaInstagram, color: 'text-pink-600' },
  { platform: 'YouTube', members: '160+', icon: FaYoutube, color: 'text-red-600' },
];
